 ...
 */
@UrlPathService(pluginType="10",name="自由编辑插件")
@Service
public class ShopStoreFreeWidget extends AbstractCmsWidget {
	
	protected void display(Map<String, String> params) {
		//静态模式数据设置
//		this.putData("data", this.storeLay.getData());//存储数据
		this.freeMarkerPaser.setPageName("ShopStoreFreeWidgetStatic");
	}
	...
	@UrlPathMethod(name = "添加", path = "/Store/AddStoreLayout10")
	...
	@UrlPathMethod(name = "删除", path = "/Store/DeleteStoreLayout10")
	...
	@UrlPathMethod(name = "编辑", path = "/Store/EditStoreFree")
	...
	@UrlPathMethod(name = "获取", path = "/Store/GetStoreFree")
