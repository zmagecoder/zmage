 ...
 */
@Service
@UrlPathService(pluginType="5",name="全分类导航")
public class ShopStoreAllNavTagWidget extends AbstractCmsWidget {
...
//		this.putData("data", navigation);
		this.freeMarkerPaser.setPageName("ShopStoreAllNavTagWidgetStatic");
	}

	@Override
	@UrlPathMethod(name = "添加", path = "/Store/AddStoreLayout5")
	...
	@Override
	@UrlPathMethod(name = "删除", path = "/Store/DeleteStoreLayout5")
	...
	@Override
	@UrlPathMethod(name = "获取", path = "/Store/GetStoreNavigation5")
	...
	@Override
	@UrlPathMethod(name = "更新", path = "/Store/EditStoreNavigation5")
