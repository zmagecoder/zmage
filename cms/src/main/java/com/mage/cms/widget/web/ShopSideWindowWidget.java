 ...
 */
@Service
public class ShopSideWindowWidget extends AbstractCmsWidget {
	protected void display(Map<String, String> params) {
		//this.putData("data", this.storeLay.getData());//存储数据
		this.freeMarkerPaser.setPageName("ShopSideWindowWidgetStatic");
	}
	...
	@UrlPathMethod(name = "添加", path = "/Store/AddStoreLayout4")
	public CmsLineResp add(String json) throws Exception {
		...
		return cmsReq.add(new CmsLayOutContentPraser() {
			...
			public String genModualCnt(Modual modual) {
				...
				showcase.setType(CmsConst.WINDOW_SIDE_TYPE_2);
				showcase.setStyle(2);
				showcase.setShowTitle(3);
				showcase.setGoodsStyle(0);
				showcase.setDirection(2);
	...
	@UrlPathMethod(name = "删除", path = "/Store/DeleteStoreLayout4")
