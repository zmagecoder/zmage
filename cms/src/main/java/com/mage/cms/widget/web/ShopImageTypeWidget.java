 ...
 */
@UrlPathService(pluginType="1",name="图片展示插件")
@Service
public class ShopImageTypeWidget extends AbstractCmsWidget {
	
	protected void display(Map<String, String> params) {
		//静态模式数据设置
//		this.putData("data", this.storeLay.getData());//存储数据
		this.freeMarkerPaser.setPageName("ShopImageTypeWidgetStatic");
	}
	...
	@UrlPathMethod(name = "添加", path = "/Store/AddStoreLayout1")
	...
	@UrlPathMethod(name = "删除", path = "/Store/DeleteStoreLayout1")
