...
get_data:function(){show_data()},get_store_link_type:function(a,b){var c=this;OpenLoadingDialog();$.ajax({url:getActionPath("GetStoreLinkType","Store"),dataType:"json",contentType:"application/json",type:"POST",data:stringify({device:c.device}),success:function(b){CloseLoadingDialog();if(!0==b.success){c.link_type_info=b.link_type_info;c.link_type_info.StoreSalesRuleData=[];c.link_type_info.StoreSalesRuleData.push({Type:-1,Name:"\u5168\u90e8\u4fc3\u9500"});c.link_type_info.StoreSalesRuleData[0].Rule=
...
1].Rule=[];c.link_type_info.StoreSalesRuleData[c.link_type_info.StoreSalesRuleData.length-1].Rule.push(c.link_type_info.StoreSalesRule[k])}}}else ShowActionError(b.error,"admin");null!=a&&a(b)},error:function(a,c,l){ShowAjaxError(a,c,l);null!=b&&b(data)}})},init_link_type:function(a,b){function c(){var b=a.find("#class1_select").find("option:selected").val();a.find("#class2_select").empty();a.find("#class3_select").empty();0<=b?(d.nav_class2=store_nav_data.store_nav.StoreNavClass1[b].StoreNavClass2,
...
plugin_icon_nav_h=getContentPath("Content/Admin/images/icon_09.png"),plugin_icon_news_text=getContentPath("Content/Admin/images/icon_03.png"),plugin_icon_news_graphic=getContentPath("Content/Admin/images/icon_04.png"),plugin_icon_free=getContentPath("Content/Admin/images/icon_10.png"),plugin_icon_message=getContentPath("Content/Admin/images/icon_11.png"),plugin_icon_coupon=getContentPath("Content/Admin/images/icon_16.png"),plugin_icon_carousel=getContentPath("Content/Admin/images/icon_12.png"),plugin_icon_nav_tag=
getContentPath("Content/Admin/images/icon_13.png"),istore_option={selector:"#store_containers",page_id:0,move_margin:0,size_margin:-10,frame_config:Constant.ISTORE_FRAME_CONFIG_PC_STYLE0,on_sized:function(a,b){$(".contentmainbox").height(b)}},plugin_option=[{plugin_type:Constant.PLUGIN_TYPE_ADVERTISING,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u5e7f\u544a\u8f6e\u64ad" src="'+plugin_icon_advertising+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_advertising+
')"></div>',tools_bar:".toolbar-box #plugin_type0",grid_cx_init:1,grid_cy_init:4,on_get_parts_size:parts_size_advertising,on_show:show_advertising,on_sized:size_advertising},{plugin_type:Constant.PLUGIN_TYPE_IMAGE,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u56fe\u7247\u5c55\u793a" src="'+plugin_icon_image+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_image+')"></div>',tools_bar:".toolbar-box #plugin_type1",grid_cx_init:1,grid_cy_init:4,on_get_parts_size:parts_size_image,
on_show:show_image,on_sized:size_image},{plugin_type:Constant.PLUGIN_TYPE_SHOWCASE1,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u5355\u6807\u7b7e\u6a71\u7a97" src="'+plugin_icon_showcase1+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_showcase1+')"></div>',tools_bar:".toolbar-box #plugin_type2",grid_cx_init:1,grid_cy_init:6,on_get_right_size:right_size_showcase_type0,on_show:show_showcase_type0,on_sized:size_showcase_type0},{plugin_type:Constant.PLUGIN_TYPE_SHOWCASE2,
plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u591a\u6807\u7b7e\u6a71\u7a97" src="'+plugin_icon_showcase2+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_showcase2+')"></div>',tools_bar:".toolbar-box #plugin_type3",grid_cx_init:1,grid_cy_init:6,on_get_right_size:right_size_showcase_type1,on_show:show_showcase_type1,on_sized:size_showcase_type1},{plugin_type:Constant.PLUGIN_TYPE_SHOWCASE3,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u4fa7\u680f\u6a71\u7a97" src="'+
plugin_icon_showcase3+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_showcase3+')"></div>',tools_bar:".toolbar-box #plugin_type4",grid_cx_init:1,grid_cy_init:3,on_get_right_size:right_size_showcase_type2,on_show:show_showcase_type2,on_sized:size_showcase_type2},{plugin_type:Constant.PLUGIN_TYPE_NAV_ALL,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u5168\u5206\u7c7b\u5bfc\u822a" src="'+plugin_icon_nav_all+'" /> </div>',icon:'<div style="background-image:url('+
plugin_icon_nav_all+')"></div>',tools_bar:".toolbar-box #plugin_type5",grid_cx_init:1,grid_cy_init:8,on_show:show_nav_all,on_sized:size_nav_all},{plugin_type:Constant.PLUGIN_TYPE_NAV_V,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u7eb5\u5411\u5206\u7c7b\u5bfc\u822a" src="'+plugin_icon_nav_v+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_nav_v+')"></div>',tools_bar:".toolbar-box #plugin_type6",grid_cx_init:1,grid_cy_init:4,on_show:show_nav_v,on_sized:size_nav_v},
{plugin_type:Constant.PLUGIN_TYPE_NEWS_TEXT,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u6587\u5b57\u65b0\u95fb" src="'+plugin_icon_news_text+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_news_text+')"></div>',tools_bar:".toolbar-box #plugin_type8",grid_cx_init:1,grid_cy_init:4,on_show:show_text_news,on_sized:size_text_news},{plugin_type:Constant.PLUGIN_TYPE_NEWS_GRAPHIC,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u56fe\u6587\u65b0\u95fb" src="'+
plugin_icon_news_graphic+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_news_graphic+')"></div>',tools_bar:".toolbar-box #plugin_type9",grid_cx_init:1,grid_cy_init:4,on_show:show_graphic_news,on_sized:size_graphic_news},{plugin_type:Constant.PLUGIN_TYPE_FREE,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u81ea\u7531\u7f16\u8f91" src="'+plugin_icon_free+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_free+')"></div>',tools_bar:".toolbar-box #plugin_type10",
grid_cx_init:1,grid_cy_init:4,on_show:show_free,on_sized:size_free},{plugin_type:Constant.PLUGIN_TYPE_MESSAGE,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u5ba2\u6237\u7559\u8a00" src="'+plugin_icon_message+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_message+')"></div>',tools_bar:".toolbar-box #plugin_type11",grid_cx_init:1,grid_cy_init:5,on_show:show_message,on_sized:size_message},{plugin_type:Constant.PLUGIN_TYPE_CAROUSEL,plugin_device:Constant.STORE_DEVICE_PC,
content:'<div><img title="\u56fe\u7247\u6eda\u64ad" src="'+plugin_icon_carousel+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_carousel+')"></div>',tools_bar:".toolbar-box #plugin_type12",grid_cx_init:1,grid_cy_init:4,on_get_parts_size:parts_size_carousel,on_show:show_carousel,on_sized:size_carousel},{plugin_type:Constant.PLUGIN_TYPE_NAV_TAG,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u6807\u7b7e\u5bfc\u822a" src="'+plugin_icon_nav_tag+'" /> </div>',icon:'<div style="background-image:url('+
plugin_icon_nav_tag+')"></div>',tools_bar:".toolbar-box #plugin_type13",grid_cx_init:1,grid_cy_init:4,on_show:show_nav_tag,on_sized:size_nav_tag},{plugin_type:Constant.PLUGIN_TYPE_COUPON,plugin_device:Constant.STORE_DEVICE_PC,content:'<div><img title="\u4f18\u60e0\u5238\u67e5\u8be2" src="'+plugin_icon_coupon+'" /> </div>',icon:'<div style="background-image:url('+plugin_icon_coupon+')"></div>',tools_bar:".toolbar-box #plugin_type16",grid_cx_init:1,grid_cy_init:5,on_show:show_coupon,on_sized:size_coupon}];
function show_title(a){try{if(a.plugin_type==Constant.PLUGIN_TYPE_SHOWCASE2)a.show_mode!=PluginConstant.SHOW_MODE_STATIC&&$("#showcase_type1_border_tmpl").tmpl(a).appendTo(a.body);else if(a.show_mode!=PluginConstant.SHOW_MODE_STATIC&&(a.plugin_type==Constant.PLUGIN_TYPE_SHOWCASE1&&(a.data.SearchKeyDisplay=null!=a.data.SearchKey?a.data.SearchKey.split("\t"):[]),$("#plugin_border_tmpl").tmpl(a).appendTo(a.body)),a.show_mode==PluginConstant.SHOW_MODE_EDIT&&permissions[permisson_map.PageContent]&&null!=
a.change_title){var b=a.body.find(".plugin_title_pic");b.find(".plugin_title").css("cursor","text");b.find(".plugin_title").click(function(){var c=b.find(".plugin_title_input");c.val($(this).text());c.width($(this).width());c.height($(this).height()-6);$(this).hide();c.show();c.focus();c.blur(function(){var k=$.trim(b.find(".plugin_title").text()),l=$.trim($(this).val());k!=l&&a.change_title(l);c.hide();c.val(k);b.find(".plugin_title").show()});c.keyup(function(a){13==a.keyCode?c.blur():27==a.keyCode&&
(c.val(b.find(".plugin_title").text()),c.blur())})})}}catch(c){}}function get_plugin_inner_size(a){return csharp_get_plugin_size(a.frame_config,a.body.width(),a.body.height(),a.plugin_type,a.data.ShowTitle)}
...
(a.body.find(".class1").css("cursor","pointer"),a.body.find(".class1").click(function(){var a=$(this).attr("class1_id");goto_search_link(null,a,null,null,null,null)}),a.body.find(".class2").css("cursor","pointer"),a.body.find(".class2").click(function(){var a=$(this).attr("class2_id");goto_search_link(null,null,a,null,null,null)}),a.body.find(".class3").css("cursor","pointer"),a.body.find(".class3").click(function(){var a=$(this).attr("class3_id");goto_search_link(null,null,null,a,null,null)}))}}catch(c){}size_nav_all(a)}
...
function show_nav_v(a){try{if(a.show_mode!=PluginConstant.SHOW_MODE_STATIC)switch(a.body.empty(),show_title(a),a.data.Style){case 0:$("#store_nav_v_tmpl").tmpl(a).appendTo(a.body.find(".plugin_inner_content"))}a.show_mode==PluginConstant.SHOW_MODE_DISPLAY&&(a.body.find(".nav_class2").click(function(){var a=$(this).attr("class2_id");goto_search_link(null,null,a,null,null,null)}),a.body.find(".nav_class3").click(function(){var a=$(this).attr("class3_id");goto_search_link(null,null,null,a,null,null)}))}catch(b){}size_nav_v(a)}
function size_nav_v(a){set_plugin_boder_size(a)}
...
null,null,null,b)}):a.show_mode==PluginConstant.SHOW_MODE_DISPLAY&&a.body.find(".tag_item").click(function(){var a=$(this).attr("item_id");goto_search_link(null,null,null,null,null,a)})}catch(b){}size_nav_tag(a)}function size_nav_tag(a){set_plugin_boder_size(a)}
function show_text_news(a){try{if(a.show_mode!=PluginConstant.SHOW_MODE_STATIC)switch(a.body.empty(),show_title(a),a.data.Style){case 0:$("#text_news_style0_tmpl").tmpl(a).appendTo(a.body.find(".plugin_inner_content"));break;case 1:$("#text_news_style1_tmpl").tmpl(a).appendTo(a.body.find(".plugin_inner_content"));break;case 2:$("#text_news_style2_tmpl").tmpl(a).appendTo(a.body.find(".plugin_inner_content"))}}catch(b){}news_click(a);size_text_news(a)}
...
function size_graphic_news(a){var b=set_plugin_boder_size(a),c=b.width,b=b.height;if(0==a.data.Style){var g=a.body.find(".graphic_news_style0_img").width(),c=c-g-5;a.body.find(".graphic_news_style0_news").width(c)}else g=a.body.find(".graphic_news_style1_img").width(),c=c-g-5,a.body.find(".graphic_news_style1_news").width(c);if(!0==a.data.Roll)switch(a.data.Style){case 0:c=a.body.find(".graphic_news_style0_list li").height();b=Math.round(b/c);a.body.find(".graphic_news_style0_list").carouFredSel({items:b,
auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_UP?"up":"down"});break;case 1:c=a.body.find(".graphic_news_style1_list li").height(),b=Math.round(b/c),a.body.find(".graphic_news_style1_list").carouFredSel({items:b,auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_UP?"up":"down"})}}
function news_click(a){switch(a.show_mode){case PluginConstant.SHOW_MODE_DISPLAY:a.body.find(".news_title").click(function(){var b=$(this).attr("news_id"),c=$(this).attr("index_id"),b=a.get_news(b);if(null!=b)switch(b.LinkType){case Constant.LINK_TYPE_NONE:goto_news_link(c,plugin_save_level);break;case Constant.LINK_TYPE_URL:goto_url_link(b.LinkParam);break;case Constant.LINK_TYPE_SEARCH:goto_search_link(b.LinkParam,null,null,null,null,null);break;case Constant.LINK_TYPE_CLASS:try{var g=$.parseJSON(b.LinkParam);
g.class1_id=null==g.class1_id||""==$.trim(g.class1_id)?null:g.class1_id;g.class2_id=null==g.class2_id||""==$.trim(g.class2_id)?null:g.class2_id;g.class3_id=null==g.class3_id||""==$.trim(g.class3_id)?null:g.class3_id;goto_search_link(null,g.class1_id,g.class2_id,g.class3_id,null,null)}catch(k){}break;case Constant.LINK_TYPE_PAGE:goto_page_link(b.LinkParam,!0);break;case Constant.LINK_TYPE_SALES:goto_search_link(null,null,null,null,b.LinkParam,null);break;case Constant.LINK_TYPE_GOODS:goto_goods_link(b.LinkParam,
!0);break;case Constant.LINK_TYPE_TAGITEM:goto_search_link(null,null,null,null,null,b.LinkParam)}})}}
...
function size_advertising(a){var b=set_plugin_boder_size(a),c=b.width,b=b.height;0==a.data.Style?(a.body.find(".banner_img li").width(c),a.body.find(".banner_img li").height(b),a.body.find(".banner_img img").width(c),a.body.find(".banner_img img").height(b),a.body.find(".banner_img").carouFredSel({items:1,auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_LEFT?"left":"right",pagination:{container:a.body.find(".banner_number"),anchorBuilder:function(a){return'<a class="bg_j" href="javascript:void(0)">'+
a+"</a>"}}})):(a.body.find(".slideshow").width(10*c),a.body.find(".slideshow").height(b),a.body.find(".slideshow li").width(c),a.body.find(".slideshow li").height(b),a.body.find(".slideshow img").width(c),a.body.find(".slideshow img").height(b),a.body.find(".next_arrow").css("top",Math.floor((b-42)/2)+"px"),a.body.find(".prev_arrow").css("top",Math.floor((b-42)/2)+"px"),a.body.find(".plugin_inner_content").mouseover(function(){a.body.find(".next_arrow_box").show();a.body.find(".prev_arrow_box").show()}).mouseout(function(){a.body.find(".next_arrow_box").hide();
a.body.find(".prev_arrow_box").hide()}),a.body.find(".slides").carouFredSel({items:1,auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_LEFT?"left":"right",prev:a.body.find(".next_arrow_box"),next:a.body.find(".prev_arrow_box")}),a.body.find(".next_arrow_box").hide(),a.body.find(".prev_arrow_box").hide())}
function image_click(a){if(null!=a)switch(a.LinkType){case Constant.LINK_TYPE_NEWS:goto_news_link(a.LinkParam,plugin_save_level);break;case Constant.LINK_TYPE_URL:goto_url_link(a.LinkParam);break;case Constant.LINK_TYPE_SEARCH:goto_search_link(a.LinkParam,null,null,null,null,null);break;case Constant.LINK_TYPE_CLASS:try{var b=$.parseJSON(a.LinkParam);b.class1_id=null==b.class1_id||""==$.trim(b.class1_id)?null:b.class1_id;b.class2_id=null==b.class2_id||""==$.trim(b.class2_id)?null:b.class2_id;b.class3_id=
null==b.class3_id||""==$.trim(b.class3_id)?null:b.class3_id;goto_search_link(null,b.class1_id,b.class2_id,b.class3_id,null,null)}catch(c){}break;case Constant.LINK_TYPE_PAGE:goto_page_link(a.LinkParam,!0);break;case Constant.LINK_TYPE_SALES:goto_search_link(null,null,null,null,a.LinkParam,null);break;case Constant.LINK_TYPE_GOODS:goto_goods_link(a.LinkParam,!0);break;case Constant.LINK_TYPE_TAGITEM:goto_search_link(null,null,null,null,null,a.LinkParam)}}
...
"0px"),a.body.find(".plugin_carousel_box li").css("margin-right","0px")):(a.body.find(".plugin_carousel_box li").css("margin-left","2px"),a.body.find(".plugin_carousel_box li").css("margin-right","2px"));a.body.find(".plugin_carousel_box li img").width(g);a.body.find(".plugin_carousel_box li img").height(k);a.body.show();a.body.find(".plugin_carousel_box").carouFredSel({items:Number(a.data.Setting.ShowNumber),auto:Number(a.data.Setting.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Setting.Direction==
Constant.PLUGIN_CAROUSEL_DIR_LEFT?"left":"right"})}
...
function size_showcase_type0(a){var b=set_plugin_boder_size(a),c=b.width;showcase_fix_goods_list(a,c,b.height);b=a.body.find(".showcase_type0_goods li").width();c=Math.floor(c/b);!0==a.data.Roll&&a.body.find(".showcase_type0_goods").carouFredSel({items:c,auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_RIGHT?"right":"left"})}
function right_size_showcase_type0(a,b,c,g,k){b=5;c=1;switch(a.data.ShowTitle){case 0:c=0;break;case 1:c=0;break;default:c=1}switch(a.data.Style){case 0:b=5;break;case 1:b=5;break;default:b=2}a={cx:g,cy:k};a.cy=k<b+c?b+c:b+c+Math.floor((k-(b+c)+(b-1))/b)*b;return a}
function show_showcase_type1(a){function b(b){var c=a.body.find(".showcase_type1_title").find(".label_list"),g=a.body.find(".showcase_type1_goods"),d=g.eq(b);if(a.show_mode==PluginConstant.SHOW_MODE_STATIC){var h=c.eq(b).attr("processed");if(null==h||"true"!=h)showcase_goods_process(a,d,null,b),c.eq(b).attr("processed","true")}c.index(this);c.removeClass("checked");c.eq(b).addClass("checked");g.hide();d.show()}try{if(a.show_mode!=PluginConstant.SHOW_MODE_STATIC){a.body.empty();show_title(a);$("#showcase_type1_tmpl").tmpl(a).appendTo(a.body.find(".plugin_inner_content"));
for(var c=0;c<a.data.Labels.length;c++)showcase_goods_process(a,a.body.find(".showcase_type1_goods").eq(c),a.data.Labels[c],c);null!=a.data.Labels&&0<a.data.Labels.length&&(a.curr_label<a.data.Labels.length?b(a.curr_label):(a.curr_label=0,b(0)))}else a.curr_label=0,b(0);a.body.find(".showcase_type1_title").find(".label_list").hover(function(){var c=a.body.find(".showcase_type1_title").find(".label_list").index(this);b(c);a.curr_label=c},function(){});switch(a.show_mode){case PluginConstant.SHOW_MODE_EDIT:permissions[permisson_map.PageContent]&&
(a.body.find(".label_list a").css("cursor","text"),a.body.find(".label_list").find("a").click(function(){var b=$(this).parents("li"),c=b.find("input");c.val($(this).text());c.width(b.width());c.height(b.height()-4);$(this).hide();c.show();c.focus();c.blur(function(){var g=$.trim(b.find("a").text()),d=$.trim(c.val()),h=b.attr("label_id");""==d?a.delete_label(h):g!=d&&a.change_label_name(h,d);c.hide();c.val(g);b.find("a").show()});c.keyup(function(a){13==a.keyCode?c.blur():27==a.keyCode&&(c.val(b.find("a").text()),
...
function size_showcase_type1(a){var b=set_plugin_boder_size(a);showcase_fix_goods_list(a,b.width,b.height)}function right_size_showcase_type1(a,b,c,g,k){b=5;switch(a.data.Style){case 0:b=5;break;case 1:b=5;break;default:b=2}a={cx:g,cy:k};a.cy=k<b+1?b+1:b+1+Math.floor((k-(b+1)+(b-1))/b)*b;return a}
...
function size_showcase_type2(a){var b=set_plugin_boder_size(a),c=b.width,b=b.height;a.body.find(".showcase_type2_goods li").width(c);a.body.find(".showcase_type2_goods .a_text").width(c-5-90);c=a.body.find(".showcase_type2_goods li").height();c=Math.floor(b/c);!0==a.data.Roll&&a.body.find(".showcase_type2_goods").carouFredSel({items:c,auto:Number(a.data.Interval),scroll:{items:1,pauseOnHover:!0},direction:a.data.Direction==Constant.PLUGIN_CAROUSEL_DIR_UP?"up":"down"})}
function right_size_showcase_type2(a,b,c,g,k){return right_size_showcase_type0(a,b,c,g,k)}
function show_message(a){function b(a,b,c){if(!CheckInput.IsEmpty(a.Contacts)&&a.Contacts.length>Constant.INPUT_REALNAME_MAX)return alert("\u59d3\u540d\u4e0d\u80fd\u5927\u4e8e"+Constant.INPUT_REALNAME_MAX+"\u4e2a\u5b57"),!1;if(""==a.Phone&&""==a.Qq)return alert("\u8bf7\u81f3\u5c11\u7559\u4e0b\u4e00\u79cd\u8054\u7cfb\u65b9\u5f0f(\u624b\u673a\u53f7\u7801\u6216QQ\u53f7\u7801)"),!1;if(""!=a.Phone&&!CheckInput.IsMobilePhone(a.Phone))return alert("\u624b\u673a\u53f7\u7801\u683c\u5f0f\u4e0d\u6b63\u786e"),!1;
...
d.Roll="True"==h.attr("Roll")||"true"==h.attr("Roll");d.Interval=h.attr("Interval");d.Direction=h.attr("Direction");break;case Constant.PLUGIN_TYPE_SHOWCASE1:case Constant.PLUGIN_TYPE_SHOWCASE2:case Constant.PLUGIN_TYPE_SHOWCASE3:h=$(this).find(".showcase_main_content"),d.GoodsStyle=h.attr("goods_style"),d.Roll="True"==h.attr("Roll")||"true"==h.attr("Roll"),d.Interval=h.attr("Interval"),d.Direction=h.attr("Direction")}a.add_plugin_layout(c,b,g,k,l,n,d)})},add_plugin_layout:function(a,b,c,g,k,l,n){var d=
this.add_plugin(b);d.plugin_id=-1;d.layout_id=a;d.grid_x=c;d.grid_y=g;d.grid_cx=k;d.grid_cy=l;d.data=n;d.is_new=!1;d.frame.remove();d.frame=this.frame.find(".plugin_containers[layout_id="+a+"]");d.body=d.frame.find(".plugin_body");d.plugin_type==Constant.PLUGIN_TYPE_NAV_ALL&&d.get_body().css("z-index",10);this.plugins.push(d);d.show_normal();d.show();setTimeout(function(){d.show_data()},0)},add_plugin:function(a){for(var b=this,c=null,g=0;g<this.plugin_option.length;g++)if(this.plugin_option[g].plugin_type==
a){c=$.extend(!0,{},this.plugin_option[g]);break}null==c&&(c={plugin_type:a,content:"<div></div>",icon:"<div></div>",tools_bar:$("<div></div>"),on_show:null,on_sized:null});a=$.extend(!0,{},c,{plugin_type:a,show_mode:PluginConstant.SHOW_MODE_STATIC,frame_config:this.istore_option.frame_config,icon:"<div></div>",content:$("<div></div>"),tools_bar:$("<div></div>"),tools_show_resize:!1,page_id:this.istore_option.page_id,containers:this.store_containers,on_remove:function(a){b.on_remove(a)}});return new iStorePlugin(a)},
on_remove:function(a){},on_moved:function(a,b,c){},on_sized:function(a,b,c){}};
